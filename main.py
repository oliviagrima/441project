...
p_theta1 = data['globes']['1']['theta']
p_z1 = data['globes']['1']['z']
p_r2 = data['globes']['2']['r']
p_theta2 = data['globes']['2']['theta']
p_z2 = data['globes']['2']['z']
p_r3 = data['globes']['3']['r']
p_theta3 = data['globes']['3']['theta']
p_z3 = data['globes']['3']['z']
